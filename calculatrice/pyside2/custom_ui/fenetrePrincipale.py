...
class Ui_form_calculatrice(object):
    ...
    def retranslateUi(self, form_calculatrice):
        form_calculatrice.setWindowTitle(QtWidgets.QApplication.translate("form_calculatrice", "Ma Calculatrice", None))
        self.btn_c.setText(QtWidgets.QApplication.translate("form_calculatrice", "C", None))
        self.btn_mult.setText(QtWidgets.QApplication.translate("form_calculatrice", "X", None))
        self.btn_5.setText(QtWidgets.QApplication.translate("form_calculatrice", "5", None))
        self.btn_point.setText(QtWidgets.QApplication.translate("form_calculatrice", ".", None))
        self.btn_egal.setText(QtWidgets.QApplication.translate("form_calculatrice", "=", None))
        self.btn_moins.setText(QtWidgets.QApplication.translate("form_calculatrice", "-", None))
        self.btn_3.setText(QtWidgets.QApplication.translate("form_calculatrice", "3", None))
        self.btn_div.setText(QtWidgets.QApplication.translate("form_calculatrice", "/", None))
        self.btn_4.setText(QtWidgets.QApplication.translate("form_calculatrice", "4", None))
        self.btn_0.setText(QtWidgets.QApplication.translate("form_calculatrice", "0", None))
        self.btn_6.setText(QtWidgets.QApplication.translate("form_calculatrice", "6", None))
        self.btn_2.setText(QtWidgets.QApplication.translate("form_calculatrice", "2", None))
        self.btn_plus.setText(QtWidgets.QApplication.translate("form_calculatrice", "+", None))
        self.btn_8.setText(QtWidgets.QApplication.translate("form_calculatrice", "8", None))
        self.btn_7.setText(QtWidgets.QApplication.translate("form_calculatrice", "7", None))
        self.btn_1.setText(QtWidgets.QApplication.translate("form_calculatrice", "1", None))
        self.btn_9.setText(QtWidgets.QApplication.translate("form_calculatrice", "9", None))
        self.le_resultat.setText(QtWidgets.QApplication.translate("form_calculatrice", "0", None))
